...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CFDocumentDetection",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@protocol CFDocumentDetectionControllerDelegate;
...
/// The <code>CFDocumentDetectionController</code> class is meant to be presented. It consists of a series of 3 different screens which guide the user:
/// <ol>
///   <li>
...
///   </li>
/// </ol>
SWIFT_CLASS_NAMED("CFDocumentDetectionController")
@interface CFDocumentDetectionController : UINavigationController
/// The object that acts as the delegate of the <code>CFDocumentDetectionController</code>.
@property (nonatomic, weak) id <CFDocumentDetectionControllerDelegate> _Nullable documentDetectionDelegate;
...
SWIFT_PROTOCOL("_TtP19CFDocumentDetection37CFDocumentDetectionControllerDelegate_")
@protocol CFDocumentDetectionControllerDelegate <NSObject>
...
///
- (void)documentDetectionController:(CFDocumentDetectionController * _Nonnull)scanner didFinishWithResults:(DocumentDetectorResult * _Nonnull)results;
...
/// \param scanner The scanner controller object managing the scanning interface.
///
- (void)documentDetectionControllerDidCancel:(CFDocumentDetectionController * _Nonnull)scanner;
/// Tells the delegate that an error occured during the user’s scanning experience.
/// \param scanner The scanner controller object managing the scanning interface.
///
/// \param error The error that occured.
///
- (void)documentDetectionController:(CFDocumentDetectionController * _Nonnull)scanner didFailWithError:(NSError * _Nonnull)error;
@end




SWIFT_CLASS("_TtC19CFDocumentDetection7Capture")
...
SWIFT_CLASS("_TtC19CFDocumentDetection16DocumentDetector")
...
SWIFT_CLASS("_TtC19CFDocumentDetection23DocumentDetectorBuilder")
...
SWIFT_CLASS("_TtC19CFDocumentDetection22DocumentDetectorResult")
...
SWIFT_CLASS("_TtC19CFDocumentDetection22DocumentScannerResults")
